	...
	<div align="center" style="padding-top: 50px;">
		...
		<table  width="740" height="500" background="images/login.jpg" >
			...
			<tr height="10">
				<td width="40%"></td>
				<td width="10%">验证码：</td>
				<td><input type="text" value="${imageCode }" name="imageCode" id="imageCode" size="10"/>&nbsp;<img onclick="javascript:loadimage();"  title="换一张试试" name="randImage" id="randImage" src="image.jsp" width="60" height="20" border="1" align="absmiddle"></td>
				<td width="30%"></td>
			</tr>
			<tr height="10">
				<td width="40%"></td>
